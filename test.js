...
test(`Poll tweet`, async () => {
  const tweet = await util.buildMarkdown(poll_tweet, {})
...
test(`Image tweet`, async () => {
  const tweet = await util.buildMarkdown(image_tweet, {})
...
test(`Mentions tweet`, async () => {
  const tweet = await util.buildMarkdown(mentions_tweet, {})
...
test(`Cashtag tweet`, async () => {
  const tweet = await util.buildMarkdown(cashtag_tweet, {})
