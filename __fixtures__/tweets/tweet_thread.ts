...
export const tweetWithMissingParent: Tweet = {
  data: {
    created_at: '2022-07-02T18:08:57.000Z',
    text: '@nevyn Flash was awesome in so many ways! Being proprietary closed-source software was not awesome though.',
    public_metrics: {
      retweet_count: 0,
      reply_count: 0,
      like_count: 13,
    ...
    conversation_id: '1543284859572867072',
    referenced_tweets: [
      {
        type: 'replied_to',
        id: '1543286531431059456',
      },
    ],
    id: '1543295680088662016',
    author_id: '2475171',
    entities: {
      mentions: [
        {
  ...
  includes: {
    users: [
      {
        profile_image_url:
          'https://pbs.twimg.com/profile_images/1432033002880520193/nuDFioj3_normal.jpg',
        id: '2475171',
